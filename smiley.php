...
if (isset($_POST['send'])) {
    ...
    file_put_contents($file, "$id|$message\n", FILE_APPEND);
}
...
<a class="navbar-brand" href="aries.html" style="font-size:15px;">Inbox</a></div>
...
<div class="chat-container">
    ...
    <div class="chat-header">Notes</div>
    ...
    <div class="chat-messages">
        ...
        if (file_exists($file)) {
            ...
            foreach ($lines as $line) {
                list($id, $message) = explode("|", trim($line));

                echo "<div class='message'>";
                echo "<span>$message</span>";
                echo "<a class='delete-btn' href='?delete=$id'>✖</a>";
                echo "</div>";
            }
        }
        ?>
