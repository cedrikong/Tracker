...
<div class="boxicon" style='background:#dff4f9'>
...
<a class="navbar-brand" href="aries.html" style="font-size:15px; color:#3ebdf8;">Tracker</a></div>
<div class="boxicon">
<svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="18" height="18">
...
<a class="navbar-brand" href="aries.html" style="font-size:15px;">Settings</a></div>
   ...
   <div class="d-grid gap-2 d-md-block" style='margin-left:200px' ><br>
    ...
    <div class="container my-4">
      <a class='btn btn-success p-1' href='create.php' type='button' style='font-size:14px; margin-bottom:5px;'>Add New</a><br>
    <table class="table" style='color:white;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);'>
    <thead>
      <tr style='background:rgb(254,254,265,0.23);'>
        <th>ID</th>
        <th>DBA</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>$row[email]</td>
        <td >$row[phone]</td>
        <td style='text-align:center';>$row[trans]</td>
        <td style='text-align:center';>$row[status]</td>
        <td style='text-align:center';>$row[join_date]</td>
        </td>
        <td style='text-align:center';>
                  <a class='btn btn-success p-1' href='edit.php?id=$row[id]' style='font-size:12px'>Edit</a>
                  <a class='btn btn-danger p-1' href='delete.php?id=$row[id]' style='font-size:12px'>Delete</a>
...
<div style="height:60px; background-color:rgb(0,0,0,0.23); padding:0.5%; float:left; width:100%; border-top: 2px solid); margin-top:993px; text-align:center; color:gray; font-family:tahoma; font-size: smaller;">Designed by<font color="#5bc2f2"> ariespogi</font> </div>
