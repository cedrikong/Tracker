...
<div class="banner">
<div style="width:1330px; margin:0 auto; margin-top:5px; color:#3bbcf6;"><div style="float:left; height:50px; margin-top:8px;"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="none" viewBox="0 0 24 24">
...
<div class="nav1" onclick="window.location.href='aries.html';">
...
<div class="bots" style="margin-left:8px;">Dashboard</div>
</div></div>
<div class="nav1" style="background-color:#dff4f9;">
...
<div class="bots" style="color:#3ebdf8;">Projects</div></div>
<div class="nav1">
<svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="18" height="18">
...
<div class="bots">Analytics</div></div>
<div class="nav1">
...
<div class="bots">Settings</div></div>
<div class="container">
...
<div style="height:30px; background-color:white; padding:0.5%; float:left; width:99%; border-top: 2px solid rgb(240, 243, 255); margin-top:5px; text-align:center; color:gray; font-family:tahoma; font-size: smaller;">Designed by<font color="#5bc2f2"> ariespogi</font> </div>
